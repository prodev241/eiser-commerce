...
const NavBar = () => {
  return (
    <>
      <div className="desktop: bg-gray-100 flex   justify-around font-sans text-gray-800 text-[14px] pt-[4px] gap-35  container mx-auto  ">
        <div>
       ...
       <div className="flex justify-around pt-[20px] pl-[21px] pr-[30px] container mx-auto">
        ...
        <div className="pt-[14px]">
          <ul className="flex gap-4 text-[15px] " >
            ...
            <li className=" hover:text-green-600"> <a href=""><FontAwesomeIcon icon={faCartShopping} /></a> </li>
